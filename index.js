...
client.on('message', msg => {
	...
	if (msg.content === 'الله اكبر') {

		msg.reply('دائما وابدا 🙏');
...
client.on('message', msg => {
	...
	if (msg.content === 'راح انام') {

		msg.reply('تصبح على خير😴');
...
client.login('NzY5MTU0NDQwMjk1ODc0NTkw.X5K45A.ujcIxtU5RgK17fqrqIjuIFGi2Vc');
